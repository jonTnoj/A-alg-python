...
pygame.display.set_caption("A* Alg")
...
def algorithm(draw, grid, start, end):
    ...
    f_score[start] = h_val(start.get_pos(), end.get_pos())
    ...
    while not open_set.empty():
        ...
        for neighbor in current.neighbors:
            ...
            if temp_g_score < g_score[neighbor]:
                ...
                f_score[neighbor] = temp_g_score + h_val(neighbor.get_pos(), end.get_pos())
...
def main(win, width):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            elif pygame.mouse.get_pressed()[2]: #right moust button
                pos = pygame.mouse.get_pos()
                row, col = get_clicked_pos(pos, ROWS, width)
                tile = grid[row][col]
                tile.reset()
